...
function Tasks() {
    ...
    //Zapisywanie zadań do LocalStorage za każdym razem, gry tasks się zmieni
    useEffect(() => {
    ...
    return (
        <section id="zadania" className="card collapsible-section">
            <h2 className="collapsible-header">Twoje Zadania <span className="toggle-icon">-</span></h2> {/* Domyślnie rozwiniete*/}
